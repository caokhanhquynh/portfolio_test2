...
const Portfolio = () => {
  ...
  const [city, setCity] = useState("Vancouver"); // Replace with desired default city
  const weatherEmojis = {
    Clear: "☀️",
    Clouds: "☁️",
    Rain: "🌧️",
  ...
  return(
          ...
          <div className="flex flex-col items-center md:items-start justify-center">
            ...
            <div className="flex flex-col gap-3 text-sm md:text-base">
              ...
              <div className="flex items-center gap-2">
                ...
                rel="noopener noreferrer"
                className="hover:text-blue-400 transition-colors">Resume</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-1 mb-8 text-center">
      ...
      <p className="text-gray-200 text-sm mb-6 md:text-base">Position: Developer Intern</p>

      <a 
        href="https://www.agilityio.com" 
        target="_blank" 
        rel="noopener noreferrer" 
        className="text-lg md:text-xl font-bold hover:text-blue-400 transition-colors">
        AgilityIO | Remote ( 01/2025 - 05/2025 )
      </a>
      <p className="text-gray-200 text-sm md:text-base">Position: Part-time Web Developeer</p>
    </div>
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-1 text-center">
      ...
      <div className="space-y-6 text-sm md:text-base">
        ...
        <div className="space-y-2">
          ...
          <div>SpringBoot, React, Flask, Angular, Next.js</div>
        </div>
        <div className="space-y-2">
          <div className="font-bold text-lg md:text-xl mb-2">Supporting Tools</div>
          <div>Render, AWS, Git, GitHub, Docker, Thymeleaf, MockMVC, OpenCV, BeautifulSoup, Matplotlib, Scikit-learn, Pandas, NumPy, PyGame, PostgreSQL, OpenGL, Linux, Ubuntu</div>
        </div>
      </div>
    </div>
    ...
    <div className="py-8 md:py-16 text-center px-4">
      ...
      <p className="text-gray-200 text-sm md:text-base">Award: Dean's Honour Roll</p>
    </div>
